...
public class UserService {
    ...
    private String channelId="-1002024429715";
    ...
    public void saveUser(Update update) {
        ...
        if (userRepository.existsByChatId(chatId)) {
            ...
            if (user.getFullName() != null && user.getProfession()!=null
                ...
                setUserState(longChatId(update), BotState.FULL_NAME);
                userFullName(update);
            }
        } else {
    ...
    private void me(Update update) {
        ...
        String text = "*Sizning malumotlaringiz \n*"
                + "Ism Familiyangiz: " + user.getFullName() +"\n"+
...
//        rowsInline.add(row2);
    ...
    public void userFullName(Update update) {
        EditMessageText editMessageText = new EditMessageText();
...
//        Level level= Level.valueOf(update.getMessage().getText());
        ...
        user.setLevel(level);
        userRepository.save(user);
        SendMessage sendMessage = new SendMessage(getChatId(update), "\uD83D\uDDC2O'zingiz yaratgan portfolio silkasini yuboring!");
        sendMessage.setReplyMarkup(new ReplyKeyboardRemove(true));
        restTemplate.postForObject(BotConstants.FOR_MESSAGE, sendMessage, Object.class);
    ...
    public void userSalary(Update update) {
        ...
        userRepository.save(user);
        SendMessage sendMessage = new SendMessage(getChatId(update), "\uD83D\uDCB5Qancha ish haqi olishni xohlaysiz?" + "\n"+
                "1-5 mln, " + "\n"+
                "5-10 mln, " +"\n"+
                "10-15 mln, " +"\n"+
                "15-20 mln, " +"\n"+
    ...
    public void executeRegisterDone(Update update,User user) {
        ...
        SendMessage sendMessage2 = new SendMessage(getChatId(update),
                "\uD83D\uDC47\uD83D\uDC47\uD83D\uDC47Sizning ma'lumotlaringiz\uD83D\uDC47\uD83D\uDC47\uD83D\uDC47 \n\n" +
                        ...
                        "\uD83D\uDCF1Telefon raqam:   " + user.getPhoneNumber() + "\n" +
                        "\uD83C\uDFDEManzilingiz:  " + user.getLocation() + "\n" +
                        "\uD83D\uDCC8Darajangiz (Junior, Junior+, Middle, Middle+, Senior):  " + user.getLevel() + "\n" +
                        "\uD83D\uDDC2O'zingiz yaratgan portfolio linki:  " + user.getPortfolioLink() + "\n" +
                        "\uD83D\uDCB5Siz taklif qilgan ish haqi:  " + user.getSalary() + "\n" +
                        "\uD83D\uDD51Sizga qanday tartibdagi ish turi ma'qul? :  " + user.getSalary() );
...
//            setUserState(longChatId(update), BotState.REGISTRATION_FINISHED);
    ...
    private void sendUserDataToChannel(Update update, User user) {
        ...
        sb.append("Yangi ro'yxatdan o'tgan foydalanuvchi:\n")
                .append("\uD83D\uDC69\uD83C\uDFFB\uD83D\uDC68Ism-Familiya: ").append(user.getFullName()).append("\n")
                ...
                .append("\uD83D\uDDC2Portfolio havolasi: ").append(user.getLevel()).append("\n")
